    ...
    <section id="intro">
        <div class="intro-container">
            <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
                ...
                <div class="carousel-item active" style="background-image: url(assets/img/intro-carousel/6.png)">
                    <div class="carousel-container">
                        <div class="container">
                            ...
                            <a href="#featured-services" class="btn-get-started scrollto animate__animated animate__fadeInUp">Register</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item" style="background-image: url(assets/img/intro-carousel/10.jpg)">
                    <div class="carousel-container">
                        <div class="container">
    ...
    <main id="main">
        ...
        <section id="about">
            <div class="container" data-aos="fade-up">
                ...
                <div class="about-cols owl-carousel about-carousel">

                    <div class="about-c" data-aos="fade-up" data-aos-delay="100">
                        <div class="about-col">
                        <div class="img">
                            <img src="assets/img/intro-carousel/7.jpg" alt="" class="img-fluid">
                            <div class="icon"><i class="ion-ios-speedometer-outline"></i></div>
                        </div>
                    ...
                    <div class="about-c" data-aos="fade-up" data-aos-delay="200">
                        <div class="about-col">
                        <div class="img">
                            <img src="assets/img/intro-carousel/10.jpg" alt="" class="img-fluid">
                    ...
                    <div class="about-c" data-aos="fade-up" data-aos-delay="300">
                        <div class="about-col">
                        <div class="img">
                            <img src="assets/img/intro-carousel/9.jpg" alt="" class="img-fluid">
